...
class EditSupplier extends Component{
      ...
      handleSubmit = event => {
            ...
            const URL = 'http://localhost:12/admin/editAdmin'
            ...
            .then(resp => {
                  ...
                  this.setState({
                        notif: true,
                        textNotif: 'Data Admin Berhasil diEdit'
                  })
            })
            .catch((err) => {
                  console.log(err)
                  ...
                  <div className="container">
                        ...
                        <div className="box-content">
                              ...
                              <div className="content">
                                    <h1 className="content-title">Edit Data Admin</h1>
                                    <form method="POST" onSubmit={this.handleSubmit}>
                                    <div className="box-label">
                                                <div className="label-form">Id Admin</div>
                                          </div>
                                          <div className="form">
                                                                  <input type="text" 
                                                                        className="supplier" 
                                                                        ...
                                                                        onChange={this.handleChangeIdAdmin}></input>
                                          </div>
                                          <div className="box-label">
